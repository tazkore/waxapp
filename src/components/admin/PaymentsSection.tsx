...
import { CreditCard, Receipt, Settings2, FileCheck2, Building2, BarChart3, ArrowDownUp, Copy } from 'lucide-react';
...
import PaymentsClipDuplicates from './payments/PaymentsClipDuplicates';
    ...
    <div className="space-y-4">
      ...
      <Tabs value={tab} onValueChange={setTab} className="w-full">
        <TabsList className="grid grid-cols-2 md:grid-cols-7 w-full md:w-auto">
          ...
          <TabsTrigger value="duplicates"><Copy className="h-4 w-4 mr-2" />Duplicados Clip</TabsTrigger>
        ...
        <TabsContent value="duplicates" className="mt-4"><PaymentsClipDuplicates /></TabsContent>
